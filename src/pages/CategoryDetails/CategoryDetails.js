    ...
    >
      <section className={styles["hero"]}>
        ...
        <p className={styles["description"]}>
          ...
          the aim of meeting the needs of customers and improving the quality of
          products since 2001 has changed its name and created the Iranian glass
      ...
      <section className={styles["catalogue"]}>
        <div className={`container ${styles["container"]}`}>
          <div className={`row wrap ${styles["catalogue-counter"]}`}>
            ...
            <div className={`col ${styles["col-4"]} row justify-end align-end`}>
              <div className="row align-end">
          ...
          <div className={styles["catalogue-data"]}>
            ...
            <div className="row wrap align-center">
              <p className={styles["catalogue-data-description"]}>
                Iran Glass Technology with more than 40 years of experience and
                with the aim of meeting the needs of customers
              </p>
